...
class order_win:
    def __init__(self,root):
        ...
        topFrame = Frame(root, bd=10, relief=RIDGE, bg='yellow')
        topFrame.pack(side=TOP)

        labelTitle = Label(topFrame, text='Restaurant Management System', font=('arial', 30, 'bold'), fg='yellow', bd=11,
                           bg='black', width=51)
        labelTitle.grid(row=0, column=0)

        # frames

        menuFrame = Frame(root, bd=14, relief=RIDGE, bg='yellow')
        ...
        drinksFrame = LabelFrame(menuFrame, text='Drinks', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='black')
        drinksFrame.pack(side=LEFT)

        cakesFrame = LabelFrame(menuFrame, text='Cakes', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='black')
        cakesFrame.pack(side=LEFT)

        rightFrame = Frame(root, bd=15, relief=RIDGE, bg='yellow')
        ...
        chicken = Checkbutton(foodFrame, text='Chicken', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                              variable=var9
                              , command=chicken)
        ...
        textchicken = Entry(foodFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
        ...
        coffee = Checkbutton(drinksFrame, text='Coffee', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                             variable=var11
                             , command=coffee)
        coffee.grid(row=1, column=0, sticky=W)

        faluda = Checkbutton(drinksFrame, text='Faluda', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                             variable=var12
                             , command=faluda)
        ...
        textfaluda = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
                           textvariable=e_faluda)
        textfaluda.grid(row=2, column=1)

        textshikanji = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
                             textvariable=e_shikanji)
        textshikanji.grid(row=3, column=1)

        textjaljeera = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
                             textvariable=e_jaljeera)
        textjaljeera.grid(row=4, column=1)

        textroohafza = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
        ...
        textbadammilk = Entry(drinksFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
        ...
        oreocake = Checkbutton(cakesFrame, text='Oreo', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                               variable=var19
                               , command=oreo)
        oreocake.grid(row=0, column=0, sticky=W)

        applecake = Checkbutton(cakesFrame, text='Apple', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                                variable=var20
                                , command=apple)
        applecake.grid(row=1, column=0, sticky=W)

        kitkatcake = Checkbutton(cakesFrame, text='Kitkat', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                                 variable=var21
                                 , command=kitkat)
        kitkatcake.grid(row=2, column=0, sticky=W)

        vanillacake = Checkbutton(cakesFrame, text='Vanilla', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                                  variable=var22
                                  , command=vanilla)
        vanillacake.grid(row=3, column=0, sticky=W)

        bananacake = Checkbutton(cakesFrame, text='Banana', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                                 variable=var23
                                 , command=banana)
        bananacake.grid(row=4, column=0, sticky=W)

        browniecake = Checkbutton(cakesFrame, text='Brownie', font=('arial', 18, 'bold'), onvalue=1, offvalue=0,
                                  variable=var24
                                  , command=brownie)
        ...
        blackforestcake = Checkbutton(cakesFrame, text='Black Forest', font=('arial', 18, 'bold'), onvalue=1,
        ...
        textvanilla = Entry(cakesFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
        ...
        textbrownie = Entry(cakesFrame, font=('arial', 18, 'bold'), bd=7, width=6, state=DISABLED,
                            textvariable=e_brownie)
        ...
        labelCostofFood = Label(costFrame, text='Cost of Food', font=('arial', 16, 'bold'), bg='black', fg='white')
        ...
        labelCostofCakes = Label(costFrame, text='Cost of Cakes', font=('arial', 16, 'bold'), bg='black',
                                 fg='white')
        ...
        labelSubTotal = Label(costFrame, text='Sub Total', font=('arial', 16, 'bold'), bg='black', fg='white')
        ...
        labelServiceTax = Label(costFrame, text='Service Tax', font=('arial', 16, 'bold'), bg='black', fg='white')
        ...
        labelTotalCost = Label(costFrame, text='Total Cost', font=('arial', 16, 'bold'), bg='black', fg='white')
        ...
        def send():
            if textReceipt.get(1.0, END) == '\n':
                ...
                root2.geometry('475x550+50+50')



                billLabel = Label(root2, text='Bill Details', font=('arial', 18, 'bold underline'), bg='black',
                                  fg='white')
                billLabel.pack(pady=5)

                textarea = Text(root2, font=('arial', 12, 'bold'), bd=3, width=48, height=20)
                ...
                textarea.insert(END, f'Service Tax\t\t\t{10}Rs\n')
                textarea.insert(END, f'Total Cost\t\t\t{subtotalofItems + 10}Rs\n')

                sendButton = Button(root2, text='SAVE', font=('arial', 19, 'bold'), bg='white', fg='black', bd=7,
                                    relief=GROOVE
                                    , command=save)
        ...
        buttonTotal = Button(buttonFrame, text='Total', font=('arial', 18, 'bold'), fg='white', bg='black', bd=3, padx=6,command=totalcost)
        buttonTotal.grid(row=0, column=0)

        buttonReceipt = Button(buttonFrame, text='Receipt', font=('arial', 18, 'bold'), fg='white', bg='black', bd=3,padx=6, command=receipt)
        buttonReceipt.grid(row=0, column=1)


        buttonSend = Button(buttonFrame, text='Bill', font=('arial', 18, 'bold'), fg='white', bg='black', bd=3, padx=6,
                            command=send)
        buttonSend.grid(row=0, column=2)

        buttonReset = Button(buttonFrame, text='Reset', font=('arial', 18, 'bold'), fg='white', bg='black', bd=3, padx=6,command=reset)
        ...
        button7 = Button(calculatorFrame, text='7', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6,
                         command=lambda: buttonClick('7'))
        button7.grid(row=1, column=0)

        button8 = Button(calculatorFrame, text='8', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6,
                         command=lambda: buttonClick('8'))
        button8.grid(row=1, column=1)

        button9 = Button(calculatorFrame, text='9', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                         , command=lambda: buttonClick('9'))
        button9.grid(row=1, column=2)

        buttonPlus = Button(calculatorFrame, text='+', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                            , command=lambda: buttonClick('+'))
        buttonPlus.grid(row=1, column=3)

        button4 = Button(calculatorFrame, text='4', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
        ...
        buttonMinus = Button(calculatorFrame, text='-', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6,
                             width=6
                             , command=lambda: buttonClick('-'))
        buttonMinus.grid(row=2, column=3)

        button1 = Button(calculatorFrame, text='1', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
        ...
        buttonMult = Button(calculatorFrame, text='*', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                            , command=lambda: buttonClick('*'))
        buttonMult.grid(row=3, column=3)

        buttonAns = Button(calculatorFrame, text='Ans', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6,
                           width=6,
                           command=answer)
        buttonAns.grid(row=4, column=0)

        buttonClear = Button(calculatorFrame, text='Clear', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6,
                             width=6
                             , command=clear)
        buttonClear.grid(row=4, column=1)

        button0 = Button(calculatorFrame, text='0', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6
                         , command=lambda: buttonClick('0'))
        button0.grid(row=4, column=2)

        buttonDiv = Button(calculatorFrame, text='/', font=('arial', 16, 'bold'), fg='yellow', bg='black', bd=6, width=6,
                           command=lambda: buttonClick('/'))
